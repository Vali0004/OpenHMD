...
# Its total link flags should look like -lmingw32 -lSDL3main -lSDL3 -lmwindows
...
IF(SDL3_LIBRARY_TEMP)
  ...
  IF(WIN32)
    SET(SDL3_LIBRARY_TEMP winmm imm32 version msimg32 ${SDL3_LIBRARY_TEMP})
  ENDIF(WIN32)
...
IF(SDL3_STATIC)
  if (UNIX AND NOT APPLE)
    EXECUTE_PROCESS(COMMAND sdl3-config --static-libs OUTPUT_VARIABLE SDL3_LINK_FLAGS)
    STRING(REGEX REPLACE "(\r?\n)+$" "" SDL3_LINK_FLAGS "${SDL3_LINK_FLAGS}")
    SET(SDL3_LIBRARY ${SDL3_LINK_FLAGS})
  ENDIF()
ENDIF(SDL3_STATIC)
